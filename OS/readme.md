...
- 📝 Project 4
  ...
  - Chapter 6.1.2 The Memory Hierarchy(Storage Technologies/Disk Storage)
  - Chapter 10. System-Level I/O

- ❗️ Caution

  - PROJECT 4 - Mount, File System Journaling은 옵션
...
## 📜 Week12 ~ 13 WIL(Weekly I Learend )

PintOS의 마지막 주차였다. file system을 공부하는 기간이었는데 사실 3주차 이후로 PintOS에 대한 손을 거의놔버려서 4주차는 기억에 남지 않는다.

물론 OS공부는 진행했는데 여기서 배운것들이 너무 많았다. 이걸 기반으로 다시금 PintOS 구현을 해봤다면 좋지않았을까 라는 생각이 든다.

심지어 마지막 주차는 설날이 껴있었고(대략 5일연휴) 더불어 집에 일이 생겨 일찍 올라가는 바람에 더더욱 PintOS와는 거리가 멀어졌었다.

뭐 아무튼 PintOS는 결국 끝이 나버렸고.. 이래저래 SWJungle 교육을 진행하면서 얻는것들이 많은데 잘 갈무리해서 오만가지 생각과 깨닳은 부분을 정리하고 고칠부분은 고치고 하는 과정이 따로 또 필요할 것 같다.

이제 나만의 무기가 시작된다. 공부할 것도 산더미고 해야할 것도 산더미이다. 걱정이 많이된다. 부담도 많이 느끼고.. 여유부리던 모든 것들을 내려놓고 다시금 몰입할때가 된거같다. 단기간에 그렇게 하기란 쉽지 않겠지만.. 무조건 해내야만 할 것 같다...
